# support-conversation Specification

## Purpose
Quiénes participan en una conversación de soporte (un cliente y un agente), cómo entran, quién figura como remitente de cada mensaje y qué reglas cumplen los mensajes que intercambian.
