...
Cómo se garantiza que los mensajes no se pierdan, no se dupliquen y lleguen en el mismo orden a ambos participantes. Es el problema clásico del ejercicio.
...
El sistema DEBE (MUST) entregar a un cliente que se reconecta todos los mensajes posteriores a su `lastSeq`, y el cliente DEBE (MUST) reenviar sus pendientes.
